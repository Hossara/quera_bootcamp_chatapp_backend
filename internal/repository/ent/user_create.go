...
func (_c *UserCreate) AddCreatedChatIDs(ids ...int) *UserCreate {
	_c.mutation.AddCreatedChatIDs(ids...)
	return _c
}

// AddCreatedChats adds the "created_chats" edges to the Chat entity.
func (_c *UserCreate) AddCreatedChats(v ...*Chat) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddCreatedChatIDs(ids...)
}

// AddMessageIDs adds the "messages" edge to the Message entity by IDs.
func (_c *UserCreate) AddMessageIDs(ids ...int) *UserCreate {
...
func (_c *UserCreate) AddChatMemberIDs(ids ...int) *UserCreate {
	_c.mutation.AddChatMemberIDs(ids...)
	return _c
}

// AddChatMembers adds the "chat_members" edges to the ChatMember entity.
func (_c *UserCreate) AddChatMembers(v ...*ChatMember) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddChatMemberIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.CreatedChatsIDs(); len(nodes) > 0 {
	...
	if nodes := _c.mutation.ChatMembersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
