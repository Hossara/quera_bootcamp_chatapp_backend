...
// HasCreatedChats applies the HasEdge predicate on the "created_chats" edge.
func HasCreatedChats() predicate.User {
...
// HasCreatedChatsWith applies the HasEdge predicate on the "created_chats" edge with a given conditions (other predicates).
func HasCreatedChatsWith(preds ...predicate.Chat) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newCreatedChatsStep()
...
// HasChatMembers applies the HasEdge predicate on the "chat_members" edge.
func HasChatMembers() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasChatMembersWith applies the HasEdge predicate on the "chat_members" edge with a given conditions (other predicates).
func HasChatMembersWith(preds ...predicate.ChatMember) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newChatMembersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
